  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-wood/5 blur-[120px]" />
      </div>
      ...
      >
        ...
        {/* 装飾線 */}
        <motion.div
          className="w-24 h-px bg-gradient-to-r from-transparent via-wood to-transparent mx-auto mb-8"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
